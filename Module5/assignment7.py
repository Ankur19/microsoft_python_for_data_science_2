...
df = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/breast-cancer-wisconsin.data', header = None)
...
for item in df.columns:
    df[item] = df[item].fillna(df[item].mean(axis = 0))
