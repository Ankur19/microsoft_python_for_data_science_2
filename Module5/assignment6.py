...
#
# .. your code here ..
mat = scipy.io.loadmat('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
df_label = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/face_labels.csv', header = None)
series = df_label.iloc[:,0]
print(len(series))
#
...
#
# .. your code here ..
data_train, data_test, label_train, label_test = train_test_split(df, series, test_size = 0.15, random_state = 7)
