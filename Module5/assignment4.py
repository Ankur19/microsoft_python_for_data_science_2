...
def doPCA(data, dimensions=2):
  ...
  model = RandomizedPCA(n_components=dimensions, random_state=7)
  model.fit(data)
  return model
...
#
# .. your code here ..
df = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/Wholesale customers data.csv')
df = df.fillna(0)
#
