...
#
# .. your code here ..
df = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/CDR.csv')
df['CallDate'] = pd.to_datetime(df['CallDate'], errors = 'raise')
df['CallTime'] = pd.to_timedelta(df['CallTime'], errors = 'raise')
print(df.head())
#
...
#
# .. your code here ..
new_df = user1[['TowerLat','TowerLon']]
kmeans = KMeans(n_clusters = 1).fit(new_df)
centroids = kmeans.cluster_centers_
ax.scatter(centroids[:,0], centroids[:,1], marker='x', c='red', alpha=0.5, linewidths=3, s=169)
ax.set_title('KMeans_centroid')
#showandtell()  # TODO: Comment this line out when you're ready to proceed
print(centroids[:,0])
print(centroids[:,1])
