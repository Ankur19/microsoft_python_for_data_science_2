...
#
# .. your code here ..
X = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/College.csv', header = 0)
#
...
#
# .. your code here ..
slice_1 = X[['Room.Board']]
slice_2 = X[['Accept']]
X_train, X_test, y_train, y_test = train_test_split(slice_1,slice_2, test_size = 0.3, random_state = 7)
#
