...
#
# .. your code here ..
X = pd.read_csv('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/life_expectancy.csv', sep = '\\t', engine = 'python')
print(X.head())
#
...
cax = ax1.imshow(X.corr(), interpolation="nearest", cmap=cmap)
ax1.grid(True)
plt.title('X_correlation')
labels=X.columns
