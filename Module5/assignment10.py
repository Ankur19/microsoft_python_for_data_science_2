...
# .. your code here ..
import glob
path = r'C:/Users/IBM_ADMIN/Desktop/DATmaster/Module5/Datasets/recordings'
files = glob.glob(path + '/0_jackson*.wav')
zero  = []
for file in files:
    sample_rate, b = wavfile.read(file)
    zero.append(b)
# 
...
#
# .. your code here ..
a = Provided_Portion * n_audio_samples
a = int(a)
X_test = test[:a]
#
...
print ("Extrapolation R^2 Score: ", float(score))
