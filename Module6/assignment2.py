...
def load(path_test, path_train):
  ...
  X_train = training.ix[::96,:n_features-1]
  y_test  = testing.ix[:,n_features-1:].values.ravel()
  y_train = training.ix[::96,n_features-1:].values.ravel()
...
X_train, X_test, y_train, y_test = load('C:/Users/IBM_ADMIN/Desktop/DATmaster/Module6/Datasets/optdigits.tes', 'C:/Users/IBM_ADMIN/Desktop/DATmaster/Module6/Datasets/optdigits.tra')
